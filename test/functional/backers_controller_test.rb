...
class BackersControllerTest < ActionController::TestCase
  ...
  test "should create backer" do
    assert_difference('Backer.count') do
      post :create, backer: { confirmed_at: @backer.confirmed_at, finished: @backer.finished, project_id: @backer.project_id, user_id: @backer.user_id, value: @backer.value }
    end
  ...
  test "should update backer" do
    put :update, id: @backer, backer: { confirmed_at: @backer.confirmed_at, finished: @backer.finished, project_id: @backer.project_id, user_id: @backer.user_id, value: @backer.value }
    assert_redirected_to backer_path(assigns(:backer))
  end
